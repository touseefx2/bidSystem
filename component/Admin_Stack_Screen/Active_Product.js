...
const cardHeight=170;
  ...
  const removeProducts=  (id)=>{
    ...
    Alert.alert(
      "",
      "Are you sure ?  you want to Delete this Product in auction ?",
      [
        {
          text: "No",
        ...
        { text: "Yes", onPress: async () => {
          ...
          try {
           ...
           if(resp){
             allOther.ToastAndroid.ToastAndroid_SB("Product delete successful")
            } 
             setloader(false)
       
           } catch (error) {
             setloader(false)
            console.log("delete prdct error try cath ==> ",error)
           }
