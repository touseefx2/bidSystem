...
const cardWidth=windowWidth-35;
  ...
  export default  function  Sale_Products(props)  {
...
useEffect(()=>
{
  ...
  const unsub = db.orderBy("createdAt","desc").onSnapshot((doc)=>{
...
<TouchableOpacity style={{marginTop:pi!==false?20:0}}
 onPress={()=>{props.navigation.navigate("View_Request_ps",{pid:Pid,vid:vid})}} >
