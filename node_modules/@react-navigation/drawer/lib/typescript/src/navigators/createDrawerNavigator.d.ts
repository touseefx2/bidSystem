...
declare function DrawerNavigator({ initialRouteName, defaultStatus, backBehavior, children, screenListeners, screenOptions, lazy, drawerContentOptions, ...rest }: Props): JSX.Element;
