...
declare function MaterialTopTabNavigator({ initialRouteName, backBehavior, children, screenListeners, screenOptions, lazy, tabBarOptions, ...rest }: Props): JSX.Element;
